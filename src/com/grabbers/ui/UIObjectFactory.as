package com.grabbers.ui
{
	...
	import com.grabbers.ui.component.MapLevelButton;
	...
	public class UIObjectFactory
	{
		...
		static public function createObject(modelType:String, pW:uint, pH:uint):UIObject {
			if (_dictObj != null && _dictObj[modelType] != null) {
				...
				if (!obj.initBasic(UIObjectFactory.getObjectBasicXml(modelType), pW, pH))
					return null;
